<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('no_tlp'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['nama']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['alamat']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['no_tlp']); ?>&nbsp;</td>
